...
print "intern"
#prcatice 2 learn how to use comments and (Pound characters).
# Anything after the # is ignored by python.
print "I can get there"
#practice 3 Numbers and Math also float point number
print float(100-85%3+0.1)
print 5 + 6 > 3 + 2
